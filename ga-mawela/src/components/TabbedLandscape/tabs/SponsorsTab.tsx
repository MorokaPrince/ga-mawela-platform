...
import CompactPartnersSlideshow from '@/components/CompactPartnersSlideshow';

export default function SponsorsTab() {
  return (
    <div className="w-full bg-metallic-blue-gradient-vertical relative py-8 px-4 bg-sponsors-tab">
      {/* Compact Partners Slideshow */}
      <CompactPartnersSlideshow />
